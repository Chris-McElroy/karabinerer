...
let baseControlsKeymap: [(String, String)] = [
    ...
    (getFromText(key: "h"), getToText(key: "f", mods: ["command"], controlOff: true)),
    (getFromText(key: "j"), getToText(key: "o", mods: ["command"], controlOff: true)),
    (getFromText(key: "j", mandMods: ["shift"]), getToText(key: "n", mods: ["command"], controlOff: true)),
